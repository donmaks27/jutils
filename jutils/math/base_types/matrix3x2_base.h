...
namespace jutils
{
    namespace math
    {
        ...
        public:
            ...
            constexpr matrix(const type x1, const type y1, const type x2, const type y2, const type x3, const type y3)
                : rows{ row_type(x1, y1), row_type(x2, y2), row_type(x3, y3) }
            {}
            constexpr matrix(const row_type& row1, const row_type& row2, const row_type& row3)
                : rows{ row1, row2, row3 }
            {}
            template<typename OtherType>
            constexpr matrix(const matrix<3, 2, OtherType>& value)
        ...
        constexpr matrix<3, 2, Type1> operator+(const matrix<3, 2, Type1>& value1, const matrix<3, 2, Type2>& value2);
        template<typename Type1, typename Type2>
        constexpr matrix<3, 2, Type1> operator-(const matrix<3, 2, Type1>& value1, const matrix<3, 2, Type2>& value2);

        template<typename Type1, typename Type2, TEMPLATE_ENABLE(is_castable<Type2, Type1>)>
        constexpr matrix<3, 2, Type1> operator*(const matrix<3, 2, Type1>& value1, const Type2& value2);
        template<typename Type1, typename Type2, TEMPLATE_ENABLE(is_castable<Type2, Type1>)>
        constexpr matrix<3, 2, Type1> operator*(const Type1& value1, const matrix<3, 2, Type2>& value2);
        template<typename Type1, typename Type2>
        constexpr vector<3, Type1> operator*(const matrix<3, 2, Type1>& value1, const vector<2, Type2>& value2);
        template<typename Type1, typename Type2>
        constexpr vector<2, Type1> operator*(const vector<3, Type1>& value1, const matrix<3, 2, Type2>& value2);
        ...
        constexpr matrix<3, 2, Type1> operator+(const matrix<3, 2, Type1>& value1, const matrix<3, 2, Type2>& value2)
        {
            return matrix<3, 2, Type1>(value1) += value2;
        }
        template <typename Type1, typename Type2>
        constexpr matrix<3, 2, Type1> operator-(const matrix<3, 2, Type1>& value1, const matrix<3, 2, Type2>& value2)
        {
        ...
        constexpr matrix<3, 2, Type1> operator*(const Type1& value1, const matrix<3, 2, Type2>& value2)
        {
            return matrix<3, 2, Type1>(value2) *= value1;
        }
        template <typename Type1, typename Type2>
        constexpr vector<3, Type1> operator*(const matrix<3, 2, Type1>& value1, const vector<2, Type2>& value2)
        {
        ...
        {
            return {
                value1.x * static_cast<Type1>(value2.rows[0].x) + value1.y * static_cast<Type1>(value2.rows[1].x) + value1.z * static_cast<Type1>(value2.rows[2].x),
                value1.x * static_cast<Type1>(value2.rows[0].y) + value1.y * static_cast<Type1>(value2.rows[1].y) + value1.z * static_cast<Type1>(value2.rows[2].y),
            };
        }
    }
}
