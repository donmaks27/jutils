...
namespace jutils
{
    namespace math
    {
        ...
        public:
            ...
            constexpr matrix(const matrix<ColumnsCount, RowsCount, OtherType>& value)
        ...
        constexpr matrix<2, 2, Type> operator*(const matrix<2, 2, Type>& value1, const matrix<2, 2, OtherType>& value2);
        template<typename Type, typename OtherType>
        constexpr typename matrix<2, 2, Type>::column_type operator*(const matrix<2, 2, Type>& value1, const typename matrix<2, 2, OtherType>::row_type& value2);
        template<typename Type, typename OtherType>
        constexpr typename matrix<2, 2, Type>::row_type operator*(const typename matrix<2, 2, OtherType>::column_type& value1, const matrix<2, 2, Type>& value2);
