...
namespace jutils
{
    namespace math
    {
        ...
        public:
            ...
            {}
            template<vector_size_type RowsCount, vector_size_type ColumnsCount, typename OtherType, TEMPLATE_ENABLE((RowsCount > 2) && ((RowsCount > 3) || (ColumnsCount > 2)))>
            ...
            template<typename OtherType>
            constexpr bool operator!=(const matrix<3, 2, OtherType>& value) const { return !this->operator==(value); }
